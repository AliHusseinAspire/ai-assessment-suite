...
export default function RegisterPage(): React.ReactElement {
  return (
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden w-1/2 overflow-hidden bg-gradient-to-br from-teal-600 via-primary to-emerald-600 lg:flex lg:flex-col lg:items-center lg:justify-center">
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-4">
        ...
        <div className="mb-8 w-full max-w-md rounded-2xl bg-gradient-to-r from-teal-600 to-primary p-6 text-center text-white lg:hidden">
